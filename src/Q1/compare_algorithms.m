function compare_algorithms(l,m,n,k,noise)
    ...
    mistakes_perceptron = perceptron_full_train(x, y, n, k, 1, 0);
    accuracy_perceptron = calculate_accuracy(mistakes_perceptron, k);
    display(accuracy_perceptron);
    display(mistakes_perceptron(end));
    mistakes_perceptron = [0,mistakes_perceptron];
    ...
    display(mistakes_pm(end));
    mistakes_pm = [0, mistakes_pm];
%     
%     %----------------------------------------------------------------------
%     
%     %This is for Winnow
%     
    ...
    display(mistakes_w(end));
    mistakes_w = [0, mistakes_w];
%     
%     %---------------------------------------------------------------------
%         
...
%     
    ...
    display(mistakes_wm(end));
    mistakes_wm = [0,mistakes_wm];
%     
%     %---------------------------------------------------------------------
%     
%     %This is for AdaGrad
%     
    ...
    display(best_a_rate);
    display(mistakes_a(end));
    mistakes_a = [0, mistakes_a];
    
    plot_graph(n, mistakes_perceptron,mistakes_pm, mistakes_w, mistakes_wm, mistakes_a);
